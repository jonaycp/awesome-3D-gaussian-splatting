...
### 4. LucidDreamer: Towards High-Fidelity Text-to-3D Generation via Interval Score Matching  
...
### 9. 4DGen: Grounded 4D Content Generation with Spatial-temporal Consistency 
